  ...
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 overflow-hidden">
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary-400 rounded-full blur-3xl opacity-10"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/10 border border-primary-500/20 rounded-full mb-6">
              ...
              <span className="text-sm text-primary-300">{dict.hero.badge}</span>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <Link
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 bg-primary-500 text-white font-semibold rounded-lg hover:bg-primary-400 transition-all shadow-lg shadow-primary-500/30 hover:shadow-xl hover:-translate-y-0.5"
              >
                {dict.hero.cta1}
          ...
          >
            <div className="relative">
              <div className="w-full aspect-square bg-gradient-to-br from-primary-600/20 to-accent-600/20 rounded-3xl border border-primary-500/20 backdrop-blur-sm p-8 flex items-center justify-center">
                <div className="text-center">
                  <Bug className="w-20 h-20 text-primary-400 mx-auto mb-4 opacity-20" />
                  <div className="text-6xl font-bold text-primary-400">∅</div>
              ...
              <div className="absolute -top-4 -right-4 bg-primary-500 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg">
                ISO 17025
              </div>
              <div className="absolute -bottom-4 -left-4 bg-accent-500 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg">
                GCF Certified
              </div>
            </div>
          </motion.div>
